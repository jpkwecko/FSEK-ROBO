...
from qualCor import qualCor1, qualCor2
...
def procurando_azul():
    global rotina
    if corCS1 == 6 and corCS2 == 6:
        tank_drive.on(10,10)
    elif corCS1 == 2 and corCS2 == 2:
        print("achei!!!!")
        print(corCS1)
        print(corCS2)
        tank_drive.on(-10, -10)
    elif corCS1 !=6 or corCS2 != 6 or corCS1 != 2 or corCS2 != 2:
...
def parede():
    global rotina
    if corCS1 != corCS2:
        if (corCS1 == 1 or corCS1 == 4 or corCS1 == 5) and (corCS2 == 6 or corCS1 == 2):
            print("A")      
            tank_drive.on(-1,3)
        elif (corCS1 == 6 or corCS1 == 2) and (corCS2 == 1 or corCS1 == 4 or corCS1 == 5):
            print("B")
            tank_drive.on(3,-1)
    elif corCS1 == corCS2 and corCS1 != 2 and corCS1 != 6 and corCS2 != 2 and corCS2 != 6:
...
def volta90():
    ...
    time.sleep(.2)
    while GS.angle <= 90 and GS.angle >= -90:
        tank_drive.on(5,-5)
        print(GS.angle)
    time.sleep(.2)
    print("SAIU 90")
...
def volta180():
    ...
    tank_drive.on_for_seconds(-5,-5, 5)
    time.sleep(.2)
    while GS.angle <= 180 and GS.angle >= -180:
        tank_drive.on(-5,5)
        print(GS.angle)
    time.sleep(.2)
    print("SAIU 180")
...
while True:
    qualCor1()
    qualCor2()
    print(corCS1 and corCS2)
    while rotina == -1:
        print("problmeas foram encontrados")
        rotina += 2
    ...
    while rotina == 3:
        if corCS1 == 1 or 4 and corCS2 == 1 or 4:
            print(corCS1 and corCS2)
            volta90()
            rotina -= 2
            time.sleep(1)
